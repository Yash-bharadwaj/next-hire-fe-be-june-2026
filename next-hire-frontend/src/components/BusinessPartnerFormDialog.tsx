  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {/* Scrollable form body — single flat grid so every label+input aligns */}
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <div className="grid grid-cols-2 gap-x-4 gap-y-4">
            ...
            {/* Email */}
            <div>
              <Label className="mb-1.5 block text-sm font-medium">Primary Email</Label>
              <Input
                type="email"
            ...
            <div className="col-span-2">
              <Label className="mb-1.5 block text-sm font-medium">Partner Type</Label>
              <div className="flex gap-6">
                {(["lead", "client", "vendor"] as const).map((type) => (
                  <div key={type} className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor={`bp-is-${type}`} className="text-sm font-normal cursor-pointer capitalize">
                      {type}
                    </Label>
                  </div>
                ))}
            ...
            {/* Priority — half width, followed by empty cell so Notes starts flush */}
            <div>
