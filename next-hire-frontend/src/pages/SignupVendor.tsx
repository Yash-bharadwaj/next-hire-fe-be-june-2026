...
export default function SignupVendor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate("/auth/verify-otp", { state: { email, message: "Please check your email for the verification code to complete your registration.", theme: "vendor" } });
    } catch { }
  ...
  return (
    <div className="h-screen flex overflow-hidden">
      ...
      {/* Left panel */}
      <div className="hidden lg:flex lg:w-[42%] bg-gradient-to-br from-vendor-700 via-vendor-600 to-vendor-500 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="absolute -bottom-24 -right-24 w-80 h-80 bg-vendor-400/10 rounded-full blur-3xl" />
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <div className="inline-flex items-center gap-2 bg-white/15 rounded-full px-3 py-1 mb-4">
              <Building2 className="w-3.5 h-3.5 text-vendor-100" />
              <span className="text-vendor-100 text-xs font-medium">Staffing Vendor</span>
            </div>
            <h1 className="text-4xl font-bold text-white leading-tight mb-3">
              Grow your<br />staffing business.
            </h1>
            <p className="text-vendor-100/75 text-sm leading-relaxed">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={label} className="flex items-center gap-3">
                ...
                <span className="text-vendor-50/90 text-sm font-medium">{label}</span>
              </div>
            ))}
          </div>
        </div>

        <p className="relative z-10 text-vendor-200/50 text-xs">© 2026 The Next Hire.</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-white px-8 overflow-y-auto py-8">
        <div className="w-full max-w-sm space-y-5">
          ...
          <div className="flex items-center gap-3 lg:hidden">
            <div className="w-9 h-9 bg-gradient-to-br from-vendor-600 to-vendor-500 rounded-xl flex items-center justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-9 h-10 text-sm border-gray-200 focus:border-vendor-500 focus:ring-vendor-500/20 ${errors.companyName ? "border-red-400" : ""}`}
                  />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-9 h-10 text-sm border-gray-200 focus:border-vendor-500 focus:ring-vendor-500/20 ${errors.contactName ? "border-red-400" : ""}`}
                  />
                </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-9 h-10 text-sm border-gray-200 focus:border-vendor-500 focus:ring-vendor-500/20 ${errors.email ? "border-red-400" : ""}`}
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-9 pr-9 h-10 text-sm border-gray-200 focus:border-vendor-500 focus:ring-vendor-500/20 ${errors.password ? "border-red-400" : ""}`}
                  />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-9 pr-9 h-10 text-sm border-gray-200 focus:border-vendor-500 focus:ring-vendor-500/20 ${errors.confirmPassword ? "border-red-400" : ""}`}
                  />
            ...
            <label className="flex items-center gap-2.5 cursor-pointer group">
              <input
                ...
                className="w-4 h-4 rounded border-gray-300 text-vendor-600 focus:ring-vendor-500 cursor-pointer"
              />
              <span className="text-xs text-gray-500 group-hover:text-gray-700 transition-colors">
                I agree to the <span className="text-vendor-600 font-medium">Terms</span> and <span className="text-vendor-600 font-medium">Privacy Policy</span>
              </span>
            </label>
            {errors.terms && <p className="text-xs text-red-500 -mt-1">{errors.terms}</p>}

            <Button type="submit" disabled={isLoading}
              className="w-full h-10 bg-vendor-600 hover:bg-vendor-700 text-white font-semibold rounded-lg text-sm flex items-center justify-center gap-2 group transition-all">
              {isLoading
          ...
          <div className="flex items-center justify-between text-sm">
            <Link to="/auth/login" className="font-medium text-vendor-600 hover:text-vendor-700 transition-colors">Sign in</Link>
            <div className="flex items-center gap-3 text-gray-400 text-xs">
              <span>Sign up as</span>
              <Link to="/auth/signup" className="font-medium text-gray-600 hover:text-vendor-600 transition-colors">Company</Link>
              <span>·</span>
              <Link to="/auth/signup-candidate" className="font-medium text-gray-600 hover:text-vendor-600 transition-colors">Candidate</Link>
            </div>
          </div>
