...
export default function JobMarketplace() {
  ...
  const handleSearch = () => {
    const newFilters = {
      ...
      experience_min: experienceLevel === "entry" ? 0 : 
                     experienceLevel === "mid" ? 3 : 
                     experienceLevel === "senior" ? 7 : undefined,
      experience_max: experienceLevel === "entry" ? 2 : 
                     experienceLevel === "mid" ? 6 : 
                     experienceLevel === "senior" ? undefined : undefined,
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium text-gray-700 mb-1 block">Job Title or Keywords</label>
                  <Input
              ...
              <Collapsible open={isClassicSearchOpen} onOpenChange={setIsClassicSearchOpen}>
                <CollapsibleTrigger asChild>
                  <Button variant="outline" className="w-full justify-between">
                    ...
                    <ChevronDown className={`h-4 w-4 transition-transform ${isClassicSearchOpen ? 'rotate-180' : ''}`} />
                  </Button>
                </CollapsibleTrigger>
        ...
        <TabsContent value="ai" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Describe your ideal job in natural language and let AI find the perfect matches
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
              ...
              <Button onClick={handleAiSearch} className="w-full" disabled={isLoading || !aiPrompt.trim()}>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-600 mb-4">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span>{job.experience_min || 0}-{job.experience_max || "+"} years exp</span>
                        </div>
                        <div className="flex items-center space-x-2">
